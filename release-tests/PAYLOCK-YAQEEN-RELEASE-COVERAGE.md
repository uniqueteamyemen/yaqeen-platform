...
The suite verifies the shared local release path. It does not replace a provider-specific production acceptance exercise or make any claim about payment processing, funds, refunds, or external provider settlement.
